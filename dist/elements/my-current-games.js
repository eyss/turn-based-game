...
export class MyCurrentGames extends ScopedElementsMixin(LitElement) {
    constructor() {
        super(...arguments);
        this.loading = true;
        this._knownProfiles = new StoreSubscriber(this, () => this._store.profilesStore.knownProfiles);
        this._myGames = new StoreSubscriber(this, () => this._store.myGames);
    }
    nicknameOf(agent) {
...
MyCurrentGames.styles = [sharedStyles];
__decorate([
    contextProvided({ context: turnBasedGameStoreContext })
], MyCurrentGames.prototype, "_store", void 0);
__decorate([
    state()
], MyCurrentGames.prototype, "loading", void 0);
//# sourceMappingURL=my-current-games.js.map